...
for job_id in xrange(num_jobs):
    ...
    train_file_full_stem = '{}exp/{}/'.format('/scratch/mmirza/results/forgetting/random_search_dropout_lwta_mnist_amazon/', job_id)
